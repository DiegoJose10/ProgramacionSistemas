...
//AE474642 DD
//6455 DW
//Se tienen que poner todos los valores en los recuadros izquierdos y despues usar los botones para ver el resultado en los recuadros derechos
import java.awt.*;
...
public class ProyectoE1 extends JFrame implements ActionListener {
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    //AreaField.setText(ConvertirDieciseis(base));
    //String base = (baseField.getText());
    //AreaField.setText(Integer.toString(ConvertirDieciseis(base)));
    String base = (baseField.getText());
    ...
    //String base2 = (baseField2.getText());
    //AreaField2.setText(ConvertirTreintaDos(base2));
